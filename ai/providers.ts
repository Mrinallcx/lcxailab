...
export const scira = customProvider({
  languageModels: {
    ...
    'scira-gpt-oss-120b': groq('openai/gpt-oss-120b'),
    'scira-gpt-oss-20b': groq('openai/gpt-oss-20b'),
    ...
    'scira-llama-3-8b': groq('llama-3.1-8b-instant'),
  },
});
...
export const models = [
  ...
  },
  {
    ...
    reasoning: false,
    experimental: false,
    category: 'Coming Soon', // temporarily moved to Coming Soon
    pdf: false,
    pro: true, // temporarily require Pro
    requiresAuth: true, // temporarily require Auth
    freeUnlimited: false,
    maxOutputTokens: 8000,
    // TODO: Re-enable for general use later
  },
  {
    value: 'scira-grok-3',
    label: 'Grok 3',
  ...
  },
  {
    value: 'scira-kimi-k2',
    label: 'Kimi K2',
    description: "Moonshot AI's Most reliable model",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Groq',
  ...
  // Experimental Models
  {
    value: 'scira-gpt-oss-120b',
    label: 'GPT-OSS 120B',
    description: "OpenAI's open-source 120B parameter model via Groq",
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Groq',
  ...
  {
    value: 'scira-gpt-oss-20b',
    label: 'GPT-OSS 20B',
    description: "OpenAI's open-source 20B parameter model via Groq",
    vision: false,
    reasoning: true,
    experimental: false,
    category: 'Groq',
