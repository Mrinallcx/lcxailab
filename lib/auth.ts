...
export const auth = betterAuth({
  ...
  plugins: [
    // Polar plugin disabled - subscription features not required for basic functionality
    // Uncomment and configure the following if you want subscription features:
    /*
    polar({
      client: polarClient,
