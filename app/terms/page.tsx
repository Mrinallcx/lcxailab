    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-neutral-600 dark:prose-p:text-neutral-400 prose-a:text-neutral-900 dark:prose-a:text-neutral-200 prose-a:no-underline hover:prose-a:text-black dark:hover:prose-a:text-white prose-headings:tracking-tight">
          <p className="text-lg">
            Welcome to LCX AI Labs. These Terms of Service govern your use of our website and services. By using LCX AI Labs,
          ...
          <p>
            By accessing or using LCX AI Labs, you acknowledge that you have read, understood, and agree to be bound by
            these Terms of Service. We reserve the right to modify these terms at any time, and such modifications shall
            be effective immediately upon posting. Your continued use of LCX AI Labs after any modifications indicates your
            acceptance of the modified terms.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            LCX AI Labs is a minimalistic AI-powered crypto search engine that helps users find information on the internet. Our
          ...
          <p>You agree not to use LCX AI Labs to:</p>
          <ul>
          ...
          <p>While we strive to provide accurate and reliable information, LCX AI Labs:</p>
          <ul>
          ...
          <p>
            ...
            LCX AI Labs should not be used as the sole source for making important decisions, especially in professional,
            medical, legal, or financial contexts.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
                    All content, features, and functionality of LCX AI Labs, including but not limited to text, graphics, logos,
        icons, images, audio clips, and software, are the property of LCX AI Labs or its licensors and are protected by
          ...
          <p>LCX AI Labs relies on third-party services to provide its functionality:</p>
          <ul>
          ...
          <p>
            By using LCX AI Labs, you acknowledge and agree that your data may be processed by these third-party services
            as described in our Privacy Policy.
          </p>

          <h2>7. Pricing and Billing</h2>
          <p>
            LCX AI Labs offers both free and paid subscription plans. For detailed pricing information, visit our{' '}
          ...
          <ul>
            ...
            <li>
              <strong>LCX AI Labs Pro:</strong> $15/month subscription with unlimited searches and access to all AI models
            </li>
          </ul>
          ...
          <h2>9. Privacy</h2>
          <p>
            Your use of LCX AI Labs is also governed by our{' '}
          ...
          <p>
            To the maximum extent permitted by law, LCX AI Labs shall not be liable for any indirect, incidental, special,
          ...
          <p>
            LCX AI Labs is provided &quot;as is&quot; and &quot;as available&quot; without any warranties of any kind,
          ...
          <p>
            We reserve the right to suspend or terminate your access to LCX AI Labs, with or without notice, for conduct
          ...
          <p>
            ...
            LCX AI Labs operates, without regard to its conflict of law provisions.
          </p>
          ...
          <div className="my-8 border-t border-neutral-200 dark:border-neutral-800 pt-8">
            <p className="text-sm text-neutral-500 dark:text-neutral-400">
              By using LCX AI Labs, you agree to these Terms of Service and our{' '}
              <Link href="/privacy-policy" className="underline">
                Privacy Policy
              </Link>
              .
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm text-neutral-500 dark:text-neutral-400">
                © {new Date().getFullYear()} LCX AI Labs by Zaid Mukaddam
              </div>
            </div>
